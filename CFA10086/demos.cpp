//============================================================================
//
// Some demo routines for Crystalfontz CFA10086 EVE accelerated displays.
//
...
#include "CFAF320240F_035T.h"
// Transparent Logo
#include "CFAF320240F_035T_Splash_PNG.h"
...
uint16_t Add_Bitmap_To_Display_List(uint16_t FWol)
  {
  //We have a LCD_WIDTHxLCD_HEIGHT (320x240) tile stored in RAM_G.
...
//for testing Reset_EVE_Coprocessor()
  ...
  if(0==first)
    ...
    //bad
    FWol=EVE_Inflate_to_RAM_G(FWol,
                              CFAF320240F_035T_ARGB2_LOGO+20,
                              LOGO_SIZE_ARGB2,
                              RAM_G_Unused_Start);
