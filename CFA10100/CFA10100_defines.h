...
// (cap-touch) https://www.crystalfontz.com/product/cfaf800480e1050sca11
// (non-touch) https://www.crystalfontz.com/product/cfaf800480e1050sna11
//
...
#define LOGO_PNG_0_ARGB2_1   (1)  //Compressed ARGB is 5564 bytes smaller
...
//============================================================================
// The defines below here describe the circuit board, display, and EVE
// accelerator to the software. Typically you will want to use these
// directly and not mess with them.
...
#define EVE_TOUCH_CAP_DEVICE (EVE_CAP_DEV_GT911)
#define EVE_PEN_UP_BUG_FIX   (0)
//Touch panel defaults to 800x480 -- typically no calibration is needed.
...
#define PIN_DRIVE_TABLE const uint8_t Pin_Drive_Table[22] PROGMEM =\
  ...
  (EVE_PINDRIVE_PCLK_LR        | EVE_PINDRIVE_LR_1p2mA),\
  ...
  (EVE_PINDRIVE_SPIM_SCLK_HR   | EVE_PINDRIVE_HR_20mA),\
  (EVE_PINDRIVE_SPIM_SS_N_HR   | EVE_PINDRIVE_HR_20mA),\
  (EVE_PINDRIVE_SPIM_MISO_HR   | EVE_PINDRIVE_HR_20mA),\
  (EVE_PINDRIVE_SPIM_MOSI_HR   | EVE_PINDRIVE_HR_20mA),\
  (EVE_PINDRIVE_SPIM_IO2_HR    | EVE_PINDRIVE_HR_20mA),\
  (EVE_PINDRIVE_SPIM_IO3_HR    | EVE_PINDRIVE_HR_20mA)\
  }
...
//   etc
// Our target is 33MHz.
// LCD_PCLK divisor of 2 gives us 30MHz
#define LCD_PCLK         (2)
//----------------------------------------------------------------------------
